 ...
 */
export const ProviderConnectionSourceSchema = z.enum(["env", "mako", "sdk", "cli"])
export type ProviderConnectionSource = z.infer<typeof ProviderConnectionSourceSchema>
...
export const ProviderConnectionStateSchema = z.discriminatedUnion("status", [
  z.object({
    ...
    problem: z.object({ source: ProviderConnectionSourceSchema, message: z.string() }).optional(),
  }),
  z.object({
...
export const ProviderConnectionActionSchema = z.discriminatedUnion("kind", [
  ...
  z.object({ kind: z.literal("sign-in-key"), apiKey: z.string().min(1).max(4_096) }),
