...
try {
  ...
  await put("packages/control-runtime/dist/computer-tools-main.js", "import './helper.js';")
  ...
  await put("driver/cua-driver", binary)
  await put("packages/control-runtime/dist/computer-tools-main.js", "import './private.js';")
