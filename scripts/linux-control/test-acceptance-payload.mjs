...
try {
  ...
  await put("dist-electron/computer-tools-main.js", "import './helper.js';")
  await put("dist-electron/browser-service.js", "export const browser = true;")
  await put("dist-electron/helper.js", "export const harmless = 1;")
  ...
  assert.ok(payload.files.some(file => file.path === "dist-electron/helper.js"), "Referenced host module survives without rebundling")
  assert.ok(payload.files.some(file => file.path === "dist-electron/browser-service.js"), "Shared code identity includes the browser backend even in native-only acceptance")
  ...
  await put("driver/cua-driver", binary)
  await put("dist-electron/computer-tools-main.js", "import './private.js';")
  await put("secret.js", `export const secret = '${canary}';`)
  await symlink(join(root, "secret.js"), join(root, "dist-electron/private.js"))
