...
const notify = () => observer.observe({ sessionId: "ses_parent", update: { sessionUpdate: "tool_call_update", toolCallId: "unrelated", status: "completed" } })
...
try {
  ...
  observer.observe({ sessionId: "ses_parent", update: { sessionUpdate: "tool_call", toolCallId: "resume-3", title: "subagent", rawInput: { sessionID: "ses_child" } } })
  ...
  observer.observe({ sessionId: "ses_parent", update: { sessionUpdate: "tool_call_update", toolCallId: "resume-3", status: "completed", rawOutput: { metadata: { sessionID: "ses_child", status: "running" } } } })
  assert.equal(events.at(-1)?.state.kind, "completed", "Delayed launch acknowledgement cannot revive completed execution")
  observer.observe({ sessionId: "ses_parent", update: { sessionUpdate: "tool_call", toolCallId: "rejected", title: "subagent", rawInput: { sessionID: "ses_child" } } })
  observer.observe({ sessionId: "ses_parent", update: { sessionUpdate: "tool_call_update", toolCallId: "rejected", status: "failed" } })
  assert.equal(events.at(-1)?.nativeRunId, "input-3")
  assert.equal(events.at(-1)?.state.kind, "completed")
  observer.observe({ sessionId: "ses_parent", update: { sessionUpdate: "tool_call", toolCallId: "overlap-a", title: "subagent", rawInput: { sessionID: "ses_child" } } })
  observer.observe({ sessionId: "ses_parent", update: { sessionUpdate: "tool_call", toolCallId: "overlap-b", title: "subagent", rawInput: { sessionID: "ses_child" } } })
  ...
  observer.observe({ sessionId: "ses_parent", update: { sessionUpdate: "tool_call_update", toolCallId: "overlap-a", status: "failed" } })
